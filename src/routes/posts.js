...
router.post("/topics/:topicId/posts/create", validations.validatePosts, postController.create);
...
router.post("/topics/:topicId/posts/:id/update", validations.validatePosts, postController.update);
